...
<div class="row" >
  ...
  <marquee width="100%" direction="right" height="40px" class="text-danger">
This is a sample scrolling text that has scrolls texts to right.
    ...
    <div class="card">
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            <h5 class="card-title text-primary">Hello <?php echo $_SESSION['firstname'] ?> 🎉</h5>
            <p class="mb-4"><span class="fw-bold"></span> </p>

            <a href="javascript:;" class="btn btn-sm btn-outline-primary">Add Money</a>
          </div>
      ...
      <div class="col-sm-12 col-lg-4 col-md-12 col-12 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <span class="fw-semibold d-block mb-1">Account Balance</span>
            <h3 class="card-title mb-2">$<?= $_SESSION['account_balance'] ?></h3>
      ...
      <div class="col-sm-12 col-lg-4 col-md-12 col-12 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title text-nowrap mb-1">$<?= $_SESSION['total_credited'] ?></h3>
      ...
      <div class=" col-lg-4 col-md-12 col-12 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title text-nowrap mb-1">$<?= $_SESSION['total_debited'] ?></h3>
