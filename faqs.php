                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="account-tab" data-bs-toggle="tab" data-bs-target="#account" type="button"
                                role="tab" aria-controls="account" aria-selected="true">account</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="affiliates-tab" data-bs-toggle="tab" data-bs-target="#affiliates" type="button"
                                role="tab" aria-controls="affiliates" aria-selected="false">affiliates</button>
                        </li>
                        <li class="nav-item" role="presentation">
            ...
            <div class="row cus-mar pt-120 pb-120 justify-content-between wow fadeInUp">
                ...
                <div class="col-xl-2 col-lg-2 col-6">
                    <div class="footer-box">
                        <h5>Support</h5>
                        <ul class="footer-link">
                            <li><a href="https://pixner.net/cdn-cgi/l/email-protection#cfbcbabfbfa0bdbb8fadaea1a4a6a0"><span class="__cf_email__" data-cfemail="33604643435c41477351525d585a5c">[email&#160;protected]</span></a></li>
