                        ...
                        <div class="col-lg-7 col-md-10">
                            <div class="main-content">
                                ...
                                <div class="bottom-area">
                                    ...
                                    <a href="login.php" class="cmn-btn second">Log in</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="top-section">
                            ...
                            <p>Freedom guaranteed trust helps over 2 million customers achieve their financial goals by helping them save
                                and invest with ease. Put that extra cash to use without putting it at risk with Freedom guaranteed trust.
                            </p>
                            <ul class="list">
                                <li class="list-item d-flex align-items-center">
                                    <span class="check d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-box text-center">
                            ...
                            <div class="content">
                                ...
                                <a href="register.php" class="btn-arrow">Start Saving
                                    <img src="assets/images/icon/arrow-right.png" alt="arrow">
                                </a>
                            </div>
                        </div>
                ...
                <div class="row justify-content-end">
                    <div class="col-lg-6">
                        <div class="section-header">
                            ...
                            <h2 class="title">Access Endless Possibilities with Freedom guaranteed trust Card</h2>
                            ...
                            <div class="card-carousel-index">
                                <div class="single">
                                    ...
                                    <div class="button-area text-center">
                                        <a href="register.php" class="cmn-btn">Get Started Now</a>
                                    </div>
                                </div>
                                <div class="single">
                                    <div class="thumb">
                    ...
                    <div class="testimonials-carousel">
                        <div class="slide-item">
                            <div class="single-slide">
                                <div class="thumb">
                                    <img src="assets/images/testomonial.png" alt="image" class="max-un">
                                </div>
                                <div class="content">
                                    <div class="top-content">
                                        <img src="assets/images/icon/quote.png" alt="quote">
                                        <h5>“I love Freedom guaranteed trust bank, they're the best”</h5>
                                        <p class="xxlr">
                                            “ It's been 2 years since I found Freedom guaranteed trust bank, and it's such a relief as a small
                                            business
                    ...
                    <div class="col-lg-6">
                        <div class="section-header text-center">
                            ...
                            <p>Get answers to all questions you have and boost your knowledge so you can save, invest
                                and spend smarter. <a href="faqs.php">See all questions here!</a></p>
                        </div>
                    </div>
                </div>
                <div class="row d-flex justify-content-center">
                ...
                <div class="col-12">
                    <div class="get-content">
                        <div class="section-text">
                            ...
                            <p>It only takes a few minutes to register your FREE Freedom guaranteed trust bank account.</p>
                        </div>
